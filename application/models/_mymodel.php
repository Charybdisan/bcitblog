...
//---------------------------------------------------------------------------
    ...
    // Return all rows in a table where 'column' contains a value 'value' in reverse
    function getAll_array_value_reversed($column, $value) {
        $this->db->order_by($this->_keyField, 'desc');
        //$query = //$this->db->get($this->_tableName);
    ...
    // Return all rows in 'table' where 'column' contains a value 'value' in reverse
    function getAll_table_array_value_reversed($table, $column, $value) {
        $this->db->order_by($this->_keyField, 'desc');
        //$query = //$this->db->get($this->_tableName);
